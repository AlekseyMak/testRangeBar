 ...
 * {@link com.example.rangebar.appyvet.rangebar.RangeBar.OnRangeBarChangeListener} to be notified when the pins
 * have
 * been moved.
 */
public class RangeBar extends View {
    ...
    private static final boolean DEFAULT_FLOATING_PINS = false;
    ...
    private boolean mFloatingPins = DEFAULT_FLOATING_PINS;
    ...
    private void rangeBarInit(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            // attributes.
            mFloatingPins = ta
                    .getBoolean(R.styleable.RangeBar_floatingPins, DEFAULT_FLOATING_PINS);
